    ...
    <div class="container-principal-amg">
        <div class="container-amg">
            <!-- <div class="formulario-container"> -->
                ...
                <!-- Results Area -->
                <fieldset class="fieldset-amg"><legend class="legend-indicator-center">RESULTS AREA</legend></fieldset>
                ...
                <div id="ventanaModal" class="modal">
                    <div class="contenido-modal">
                        ...
                        <div class="group-inter-button">
                            <input type="button" name="approvemo" id="approvemo" class="approvemo" value="Approve">
